...
# these are already configured with author, paper name and then each word and its ********
dat <- read.csv('C:/Users/Joyce/Desktop/Syracuse/IST707/Homework/HW5/fedPapers85.csv')

# Make a training set and an testing set
#1. Training set
#2. Testing set
...
#We can see that, out of the 11 disputed papers, the model classifies three as authored by Madison, one by Jay, 
# and the remaining seven as a 50/50 chance being authored either by Hamilton or Hamilton *and* Madison!
