...
##  In class activity #4
##
##  1) Read in corpus from directory
##
##  2) Determine which documents are "similar"
##
##  3) (If time) Cluster results to confirm "similarity". 
##
##  4) Create a document that you predict will fall into same cluster  
##    as Doc1. Did it? Why? Do the same for cluster with Doc3.
##
##Adapted from ... 
##
