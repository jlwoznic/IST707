...
setwd("C:\\Users\\jerem\\Google Drive\\Online\\iCuse\\IST707\\Week9")
...
## it that row. I will test this on a small matrix first to make 
...
(Novels_M[c(1:3),c(1:8)])
(Novels_Matrix_Norm[c(1:3),c(1:8)])
...
str(X)
## k means
kmeansFIT_1 <- kmeans(X,centers=7)
#(kmeansFIT1)
summary(kmeansFIT_1)
#(kmeansFIT_1$cluster)
...
(findFreqTerms(Novels_dtm, 1000))
## Find assocations with aselected conf
(findAssocs(Novels_dtm, 'world', 0.80))
